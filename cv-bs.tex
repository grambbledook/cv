...
%==== Experience ====%
    ...
    \begin{itemize}
        ...
        \item Automated the release process so OSS, Enterprise, and Cloud customers get new versions
        and security patches on schedule, saving dozens of engineering hours per release.
    \end{itemize}
