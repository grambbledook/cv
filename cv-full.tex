...
% The complete history, and the copy that actually gets sent: real links only.
\usepackage[noprank]{cvstyle}
...
%==== Experience ====%
    ...
    \employer{Grid Dynamics}{Senior Software/Data Engineer}{November 2015 -- August 2017}{Saint Petersburg, Russia}
    \begin{itemize}
    ...
    \employer{Luxoft}{Senior Software Engineer}{June 2014 -- November 2015}{Saint Petersburg, Russia}
    \begin{itemize}
        \item Working on distributed non-relative data storage for Deutsche Bank.
    \end{itemize}
