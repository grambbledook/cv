...
%==== Experience ====%
    ...
    \begin{itemize}[itemsep=-1mm]
        \item Automating Grafana releases so OSS, Enterprise, and Cloud customers get the latest Grafana on time.
    \end{itemize}
    ...
    \employer{Luxoft}{Senior Software Engineer}{November 2015 - August 2017}{Saint–Petersburg, Russia}
    \begin{itemize}[itemsep=-1mm]
